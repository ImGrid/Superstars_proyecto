      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>Muestra la barra lateral en el móvil.</SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      <span className="sr-only">Abrir o cerrar la barra lateral</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label="Abrir o cerrar la barra lateral"
      tabIndex={-1}
      onClick={toggleSidebar}
      title="Abrir o cerrar la barra lateral"
      className={cn(
