      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Link
            ...
            className="flex w-full shrink-0 items-center justify-center gap-2.5 rounded-xl px-4 py-3 font-display text-xs font-bold text-white transition-opacity hover:opacity-90 sm:w-auto sm:text-base"
