...
export function SubCriterioItem({
  ...
  const updateMutation = useMutation({
    mutationFn: (data: { nombre?: string; pesoPorcentaje?: number; orden?: number }) =>
      updateSubCriterio(concursoId, subCriterio.id, data),
    onSuccess: () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: () => deleteSubCriterio(concursoId, subCriterio.id),
    onSuccess: () => {
  ...
  const reorderMutation = useMutation({
    mutationFn: (newOrden: number) =>
      updateSubCriterio(concursoId, subCriterio.id, { orden: newOrden }),
