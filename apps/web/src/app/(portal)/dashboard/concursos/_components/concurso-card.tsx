    ...
    <Card className="flex flex-col transition-shadow hover:shadow-md">
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between gap-2">
          ...
          <DiasRestantesBadge fecha={concurso.fechaCierrePostulacion} />
        </div>
      ...
      <CardContent className="flex-1 space-y-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-secondary-400">
            ({concurso.numeroGanadores} ganador{concurso.numeroGanadores !== 1 && "es"})
          </span>
        </div>
        ...
        <div className="flex items-center gap-2 text-sm text-secondary-600">
          ...
          <span>
            {formatDate(concurso.fechaInicioPostulacion)} — {formatDate(concurso.fechaCierrePostulacion)}
          </span>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="flex flex-wrap gap-1">
            {concurso.departamentos.map((dep) => (
