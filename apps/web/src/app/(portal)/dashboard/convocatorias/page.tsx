...
import { ConvocatoriasProponente } from "./_components/convocatorias-proponente";

// opciones del filtro de estado
const estadoOptions = [
  { value: "all", label: "Todos los estados" },
  { value: EstadoConvocatoria.BORRADOR, label: "Borrador" },
  { value: EstadoConvocatoria.PUBLICADO, label: "Publicado" },
  { value: EstadoConvocatoria.CERRADO, label: "Cerrado" },
  { value: EstadoConvocatoria.EN_EVALUACION, label: "En Evaluación" },
  { value: EstadoConvocatoria.FINALIZADO, label: "Finalizado" },
];

// columnas de la tabla
const columns: Column<ConvocatoriaResponse>[] = [
  {
    key: "nombre",
    header: "Nombre",
    cell: (row) => (
  ...
  },
  {
    key: "acciones",
    header: "",
    cell: (row) => <ConvocatoriaActions convocatoria={row} />,
    className: "w-12",
  },
];
...
function ConvocatoriasAdminContent() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Convocatorias"
        description="Gestiona las convocatorias de la plataforma."
        action={
          <Button onClick={() => router.push("/dashboard/convocatorias/nuevo")}>
